...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-white parallax filter filter-color-red"">
  ...
  <section id="banner">
    ...
    <div class="mbr-overlay" style="opacity: 0.1; background-color: rgb(51, 51, 51);">
    </div>
    <div class="container text-center" data-stellar-background-ratio=".5">
      <div class="row slider-wrapper">
        <div class="col-md-12">
            <div class="slider-text  slider-text-two">
              <h2 class="mbr-section-title mbr-fonts-style mbr-bold align-center display-1" style="color:black">Escape Game St Colomban</h2>
              <h1 class="mbr-text mbr-fonts-style align-center display-7" style="color:black">Venez participer à l'Escape Game du téléthon de St Colomban, créé par des Etudiant de St Félix La Salle<h1>
            </div>
        </div>
      </div>
    </div>
  ...
  <div class="w3-display-bottommiddle w3-padding-64">
         <a href="public/index_1.php" class="shiny-btn body">Inscription</a> 
