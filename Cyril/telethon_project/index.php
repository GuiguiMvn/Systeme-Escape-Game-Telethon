...
<html><head>
	...
	<body class="landing">
		...
		<!-- Header -->
			<header id="header">
                            <h1><a href="index.php">Spatial</a></h1>
				<nav id="nav">
					<ul>
                                            <li><a href="index.php">Menu</a></li>
                                                <li><a href="Lieux.php">Lieu</a></li>
		...
		<!-- Banner -->
			<section id="banner">
				<h2>Escape Game</h2>
				<p>Inscrivez vous gratuitement à l'Escape Game de l'association telethon de Saint Colomban ! <br></p>
				<ul class="actions">
...
<a href="#navPanel" class="navPanelToggle"></a><div id="navPanel" class="">
					<ul>
