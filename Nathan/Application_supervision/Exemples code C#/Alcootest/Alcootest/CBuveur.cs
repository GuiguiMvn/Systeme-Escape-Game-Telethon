...

{
    class CBuveur
    {
        ...
        private double taux_alcoolemie;     // en gramme par litre
        ...
        public void MAJ_alcoolemie (int nb_verre,int qte, double tx)
        {
            double qte_totale_alc_absorbee; // en grammes

            qte_totale_alc_absorbee = (nb_verre * tx * qte * 8 * 0.01);
